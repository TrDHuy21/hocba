...
DROP USER if exists 'congcuphattrien'@'%' ;

-- Now create user with prop privileges
CREATE USER 'congcuphattrien'@'%' IDENTIFIED BY 'congcuphattrien';

GRANT ALL PRIVILEGES ON * . * TO 'congcuphattrien'@'%';


-- drop database
DROP SCHEMA IF EXISTS `hoc_ba_dien_tu_ccpt`;

-- create database
CREATE SCHEMA `hoc_ba_dien_tu_ccpt`;

use hoc_ba_dien_tu_ccpt;
